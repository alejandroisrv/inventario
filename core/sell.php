...
//Insertar la venta
 ...
 $modoventa=$_COOKIE['modoventa'];
  $sqldetalle="INSERT INTO `detalle` (`idproducto`,`codigo`,`producto`,`cantidad`, `precio`,`modo`,`fecha`)
  VALUES ('$idproducto','$codigo','$nombre', '$cantidad', '$precio','$modoventa', now())";
  $queryDetalle=$con_pdo->query($sqldetalle);
