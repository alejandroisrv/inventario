...
$Total=$totalEnVentas+$totalDelivery;
...
$html.= "
      ...
      <tr><td class='tabla-balance tabla-balance-left';>Total en visa</td><td class='tabla-balance tabla-balance-left';>".money_format('%(#10n',$totalDeliveryVisa)."</td></tr>
            <tr><td class='tabla-balance tabla-balance-left';>Porcentaje 3.8% </td><td class='tabla-balance tabla-balance-left';>".money_format('%(#10n',$porcentajeDelivery)."</td></tr>
      <tr><th>Total</th><th>".money_format('%(#10n',$totalDelivery)."</th></tr>
      <tr><th class='total-balance'>Total:</th><th>".$totalEnVentas." + ". $totalDelivery." = ".money_format('%(#10n',$Total). " </th></tr>
      <tr><th>Gastos</th></tr>
