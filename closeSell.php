...
?>
   ...
   <?php endif;?>
     ...
     <div class="form-group text-center">
      ...
      <ul class="list-inline">
        ...
        <li class="list-inline-item px-2 py-2"><img src="https://live.pystatic.com/webassets/whitelabel/domicilios/logo-smartbanner-aacdacbc1e9866f7563298ded2fa39c5.png" alt=""></li>
      </ul>
    </div>
  ...
  var a = document.createElement("a");
		...
		if($_COOKIE['modoventa']=="delivery"): echo "&delivery=true";  endif; ?>';
		a.click();
  });
  <?php endif; ?>
  var metodoPago;
